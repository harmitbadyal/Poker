...
/******************************** Implement your methods here ****************************************/
	...
	public int numPairs() 
	{
		...
		else 
		{
			...
			{
				la = i;
				firsttt = newHand.hand[la].getValue();
				
				for(int j = i + 1; j < 5; j++)
				{
					la2 = j;
					seconddd = newHand.hand[la2].getValue();
					if (firsttt == seconddd) {
						numPairs++;
					}
				}
	...
	public boolean hasTriplet() 
	{
		...
		Hand newSet = new Hand();
		for (int i = 0; i < 5; i++)
		{
			newSet.addCard(this.hand[i]);
		}
		newSet.sortByValue();
		
		if(newSet.hasFourOfAKind()==true)
		{
			hasTriplet = true;
			return hasTriplet;
		}
		
		if(newSet.hand[2].getValue() == newSet.hand[0].getValue())
		{
			hasTriplet = true;
			return hasTriplet;
		}
		else if(newSet.hand[3].getValue() == newSet.hand[1].getValue())
		{
			hasTriplet = true;
			return hasTriplet;
		}
		else if(newSet.hand[4].getValue() == newSet.hand[2].getValue())
		{
			hasTriplet = true;
			return hasTriplet;
		}
	...
	public boolean hasFullHouse() 
	{
		...
		if (newHand.hasTriplet() == true && newHand.numPairs() == 2) 
		{
			hasFullHouse = true;
		}
		return hasFullHouse;
	...
	public boolean hasStraightFlush() {
		...
		boolean reeek = (newHand.hasStraight()) && (newHand.hasFlush());
	...
	public Card highestValue() 
	{
		...
		for (int i = 0; i < 5; i++)
		{
			alooo.addCard(this.hand[i]);
		}
		alooo.sortByValue();
		
		if (alooo.hand[0].getValue() == 1)
		{
			highestValue = alooo.hand[0];
			return highestValue;
		}
		highestValue = alooo.hand[4];
	...
	public int compareTo(Hand h) 
	{
		...
		else
		{
			...
			if(newHand1.secondValue() != null)
			{
				if (newHand1.secondValue().getValue() == 1)
				{
					hand1Value += 14;
				}
				else
				{
					hand1Value += newHand1.secondValue().getValue();		
				}
				
				if (newHand2.secondValue().getValue() == 1)
				{
					hand2Value += 14;
				}
				else
				{
					hand2Value += newHand2.secondValue().getValue();		
				}
